    ...
    <section className="py-16 lg:py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 particles-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 lg:mb-16 animate-fade-in-up">
          <div className="inline-flex items-center bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-full text-base lg:text-lg font-black mb-6 lg:mb-8 shadow-blue-glow hover-lift-intense">
            <Zap className="w-5 h-5 lg:w-6 lg:h-6 mr-2 lg:mr-3 animate-pulse" />
            LÍDERES DEL SECTOR
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-12 lg:mb-16">
            {stats.map((stat, index) => (
              <div key={index} className="card-impact rounded-2xl p-4 lg:p-6 hover-lift-intense animate-fade-in-up" style={{animationDelay: `${index * 0.1}s`}}>
                <div className={`w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center mx-auto mb-3 lg:mb-4 shadow-blue-glow`}>
                  <stat.icon className="w-6 h-6 lg:w-8 lg:h-8 text-white" />
                </div>
                <div className="text-2xl lg:text-3xl font-black text-gray-900 mb-1 lg:mb-2 text-glow">{stat.number}</div>
        ...
        <div className="text-center mb-12 lg:mb-16 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
          ...
          <p className="text-lg lg:text-xl text-gray-700 max-w-4xl mx-auto">
            <span className="text-blue-600 font-black text-xl lg:text-2xl text-glow">EXPERTOS CON AÑOS DE EXPERIENCIA</span> utilizando IA avanzada
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div key={index} className={`card-impact rounded-2xl p-6 lg:p-8 hover-lift-intense shine-effect animate-fade-in-up`} style={{animationDelay: `${index * 0.1}s`}}>
        ...
        <div className="mt-12 lg:mt-16 text-center animate-fade-in-up" style={{animationDelay: '0.8s'}}>
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-3xl p-8 lg:p-10 text-white shadow-blue-intense">
            <div className="flex items-center justify-center space-x-3 lg:space-x-4 mb-4 lg:mb-6">
              <Star className="w-6 h-6 lg:w-8 lg:h-8 text-yellow-400 fill-current animate-pulse" />
            ...
            <a href="#formulario" className="inline-flex items-center bg-white text-blue-700 px-8 lg:px-10 py-4 lg:py-5 rounded-2xl font-black text-lg lg:text-xl hover-lift-intense shine-effect shadow-lg">
